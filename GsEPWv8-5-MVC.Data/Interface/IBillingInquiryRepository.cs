...
{
    public interface IBillingInquiryRepository

    {
        BillingInquiry GetBillingInquiryDetails(BillingInquiry objLogin);
        BillingInquiry GetConsolidateInoutBillDetails(BillingInquiry objLogin);
        ...
        BillingInquiry GetBillDeleteByPallet(BillingInquiry objLogin);
        ...
        BillingInquiry GetConsolidateVASBillEntityValue(BillingInquiry objLogin);
        BillingInquiry SaveConsolidateBillDetails(BillingInquiry objLogin);
