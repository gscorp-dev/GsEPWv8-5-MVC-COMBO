...
{
    public interface IInboundInquiryRepository
    {
        ...
        InboundInquiry GetInboundInquiryDetails(InboundInquiry objLogin);
        InboundInquiry GetIbDocIdDetail(InboundInquiry objLogin);
        InboundInquiry GetInboundAckRptDetails(InboundInquiry objLogin);
        ...
        InboundInquiry GetInboundWorkSheetRptDetails(InboundInquiry objLogin);
        ...
        InboundInquiry GetInboundTallySheetRptDetails(InboundInquiry objLogin);
        InboundInquiry ItemXGetitmDetails(string term, string cmp_id);
        InboundInquiry GetInboundConfirmationRptDetails(InboundInquiry objLogin);
        InboundInquiry GetInboundHdrDtl(InboundInquiry objLogin);
        InboundInquiry GetInboundGridSummaryDetails(InboundInquiry objLogin);
        InboundInquiry GetInboundDtl(InboundInquiry objLogin);
        InboundInquiry GetInboundLotDtl(InboundInquiry objLogin);
        ...
        InboundInquiry GetTotal(InboundInquiry objInboundInquiry);
