...
{
    public interface IOutboundInqRepository
    {
        ...
        OutboundInq GetCheckExistGridData(OutboundInq objOutboundInq);
        ...
        OBCtnLblPrnt GetCtnLabelPrint(OBCtnLblPrnt objOBCtnLblPrnt, string p_str_cmp_id, string p_str_so_num);
        ...
        bool SaveOBBulkAlocPost(string p_str_cmp_id, string p_str_aloc_tmp_ref_no,  DataTable dtAlocList);
