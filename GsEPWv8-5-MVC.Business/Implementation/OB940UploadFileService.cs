...
{
   public class OB940UploadFileService : IOB940UploadFileService
    {
        ...
        {
            return objRepository.fnGetOBDocListBy940(pstrCmpId, pstrUploadRefNo);
        }
        public DataTable fnGetCustConfig(string p_str_cmp_id)
        {
            return objRepository.fnGetCustConfig(p_str_cmp_id);
        }
