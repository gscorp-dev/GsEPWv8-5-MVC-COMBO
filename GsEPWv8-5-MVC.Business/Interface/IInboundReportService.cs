...
namespace GsEPWv8_5_MVC.Business.Interface
{
    public interface IInboundReportService
    {
        ...
        DataTable GetInboundRptDateExcel(string l_str_cmp_id, string p_str_cntr_id, string l_str_whs_id, string l_str_IBDocNumFm, string l_str_IBDocNumTo, string l_InboundRcvdDtFm, string L_InboundRcvdDtTo, string p_str_itm_num, string p_str_itm_color, string p_str_itm_size, string p_str_itm_name, string p_str_status);
        DataTable GetInboundRptStyleExcel(string l_str_cmp_id, string p_str_cntr_id, string l_str_whs_id, string l_str_IBDocNumFm, string l_str_IBDocNumTo, string l_InboundRcvdDtFm, string l_InboundRcvdDtTo, string p_str_itm_num, string p_str_itm_color, string p_str_itm_size, string p_str_itm_name, string p_str_status);
