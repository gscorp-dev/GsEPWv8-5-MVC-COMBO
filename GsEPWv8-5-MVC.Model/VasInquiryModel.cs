...
{
    public class VasInquiryDtlModel : BasicEntity
    {
    ...
    public class VasHdrNew
    {
        public string cmp_id { get; set; }
        public string vas_id { get; set; }
        public string vas_dt { get; set; }
        public string so_num { get; set; }
        public string ship_to_id { get; set; }
        public string cust_po_num { get; set; }
        public string cust_po_dt { get; set; }
    ...
    public class VasInquiryModel : VasInquiryDtlModel
    {
        //List Fetch Details
