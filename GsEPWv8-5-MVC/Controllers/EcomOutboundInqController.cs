...
{
    public class EcomOutboundInqController : Controller
    {
        ...
        int Avail = 0; int ReqQty = 0;
        int Order_Qty = 0;
        int AvailQty = 0;
        int BackOrder_Qty = 0;
        int  grddtl_AlocdQty, Allocation_Line_Num = 0;
        ...
        int  SelQty, ToAlocQty, BalQty,  grdAlocQty = 0;
        ...
        [HttpGet]
        public ActionResult EcomOutboundInq(string FullFillType, string cmp, string status, string DateFm, string DateTo, string screentitle)
        {
            ...
            try
            {
                ...
                Session["screentitle"] = objOutboundInq.screentitle;
                ...
                objOutboundInq.screentitle = "";
                objOutboundInq.so_numFm = "";
                objOutboundInq.so_numTo = "";
                objOutboundInq.so_dtFm = "";
                objOutboundInq.so_dtTo = "";
                objOutboundInq.cust_ordr_num = "";
                objOutboundInq.aloc_doc_id = "";
                objOutboundInq.store_id = "";
                objOutboundInq.quote_num = "";
                ...
                objOutboundInq.itm_num = "";
                objOutboundInq.itm_color = "";
                objOutboundInq.itm_size = "";
        ...
        public FileStreamResult ViewDocument(string path, string ext)
        {
        ...
        public ActionResult EcomBatchPrint(string p_str_cmp_id, string p_str_batch_id, string pintTotOrders, string pintOpenOrders, string pintAlocOrders, string pintShipOrders)
        {
            ...
            try
            {
                ...
                strReportName = "rpt_ecom_batch_print_by_loc.rpt";
               string strDateFormat = DateTime.Now.ToString("yyyyMMddHHssmm");
                ...
                OutboundInqService ServiceObject = new OutboundInqService();
                    string strRptPath = System.Web.HttpContext.Current.Server.MapPath("~/") + "Reports//Outbound//" + strReportName;
                     objOutboundInq = ServiceObject.fnEcomBatchPrint( p_str_cmp_id, p_str_batch_id);
                    if ((objOutboundInq.ListEcomPrintAloc.Count > 0) || (objOutboundInq.ListEcomPrintDoc.Count > 0))
                    {
                    }
                    else
                    {
                    ...
                    var rptSource = objOutboundInq.ListEcomPrintAloc.ToList();
                    if (rptSource.Count > 0)
                    {
                        ...
                        rd.SetParameterValue("fml_image_path", System.Web.HttpContext.Current.Server.MapPath("~/") + objCustMaster.ListGetCustLogo[0].cust_logo.Trim());
                        reportFileName = "1-PICK" + "-" + p_str_cmp_id + "-" + p_str_batch_id  + "-" + strDateFormat + ".pdf";
                        Folderpath = System.Configuration.ConfigurationManager.AppSettings["tempFilepath"].ToString().Trim();
                        strPDFFileName = System.Web.HttpContext.Current.Server.MapPath("~/") + Folderpath + "//" + reportFileName;
                    ...
                    string lstrMergedLabelFile = string.Empty;
                        ...
                        lstrMergedPDFFile = System.Web.HttpContext.Current.Server.MapPath("~/") + Folderpath + "//" + p_str_cmp_id + "-" + p_str_batch_id + "-PRINTSLIP-" + strDateFormat + ".pdf";
                        lstrFilePath = System.Web.HttpContext.Current.Server.MapPath("~/") + Folderpath + "//";

                    lintPdfFile = objOutboundInq.ListEcomPrintDoc.Count;
                    if (lintPdfFile > 0)
                    {
                        lintPdfFile = lintPdfFile + 1;
                    }
                        string[] PdfFileArray = new string[lintPdfFile ];
                        //int lintLblCount = 0;
                        int lintPdfCount = 0;
                        ...
                        for (int i = 0; i < objOutboundInq.ListEcomPrintDoc.Count; i++)
                        {

                            //{
                                strattachedFileName = Path.Combine(System.Configuration.ConfigurationManager.AppSettings["Docpath"].ToString().Trim(), objOutboundInq.ListEcomPrintDoc[i].file_path, objOutboundInq.ListEcomPrintDoc[i].upload_file_name);
                        ...
                        string strBatchPrintPath = Path.Combine(System.Configuration.ConfigurationManager.AppSettings["Docpath"].ToString().Trim(), p_str_cmp_id, "BATCH-PRINT");

                        if (!Directory.Exists(strBatchPrintPath))
                        {
                            Directory.CreateDirectory(strBatchPrintPath);
                        }

                        string strBatchPrintfile = Path.Combine(strBatchPrintPath, p_str_batch_id + ".pdf");
                        System.IO.File.Copy(lstrMergedPDFFile, strBatchPrintfile,true);
                    }
                        ...
                        else
                    {
                        ...
                        string strBatchPrintfile = Path.Combine(strBatchPrintPath, p_str_batch_id + ".pdf");
                        System.IO.File.Copy(strPDFFileName, strBatchPrintfile, true);
                    }
                    ...
                    clsEComPrintOrders objEComPrintOrders = new clsEComPrintOrders();
                    objEComPrintOrders.cmp_id = p_str_cmp_id;
                    objEComPrintOrders.batch_id = p_str_batch_id;

                    objEComPrintOrders.total_orders =  Convert.ToInt32( pintTotOrders);
                    objEComPrintOrders.open_orders = Convert.ToInt32(pintOpenOrders);

                    objEComPrintOrders.alloc_orders = Convert.ToInt32(pintAlocOrders);
                    objEComPrintOrders.shipped_orders = Convert.ToInt32(pintShipOrders);

                    objEComPrintOrders.printed_dt = DateTime.Now.ToString();
                    objEComPrintOrders.printed_by = Session["UserID"].ToString().Trim();
                    objEComPrintOrders.batch_status = "PRINT";
                    objEComPrintOrders.mode = "UPDATE";
                    objEComPrintOrders.batch_file_name = p_str_batch_id + ".pdf";
                    bool lblnSaved = false;
                    lblnSaved = ServiceObject.fnEcomSaveBatchPrint(objEComPrintOrders);
                    if (lintPdfCount >= 1)
                    {
                        objEComPrintOrders.print_file_name = lstrMergedPDFFile;
                        //return Json(lstrMergedPDFFile, JsonRequestBehavior.AllowGet);
                        return Json(objEComPrintOrders, JsonRequestBehavior.AllowGet);
                    }
                    else
                    {
                        objEComPrintOrders.print_file_name = strPDFFileName;
                        return Json(objEComPrintOrders, JsonRequestBehavior.AllowGet);
                        //return Json(strPDFFileName, JsonRequestBehavior.AllowGet);
                    }
        ...
        public ActionResult EcomBatchPrintExistsDoc(string p_str_cmp_id, string p_str_batch_id)
        {

            string strPDFFileName = Path.Combine(System.Configuration.ConfigurationManager.AppSettings["Docpath"].ToString().Trim(), p_str_cmp_id, "BATCH-PRINT", p_str_batch_id + ".pdf");
        ...
        public ActionResult ShowPDFReport(string strPDFFileName, string p_str_cmp_id)
        {
            FileStream fs = new FileStream(strPDFFileName, FileMode.Open, FileAccess.Read);
            return File(fs, "application/pdf");
        }
        ...
        public ActionResult GetOutboundInqDetail(string p_str_cmp_id, string p_str_so_num_frm, string p_str_so_num_To, string p_str_so_dt_frm, string p_str_so_dt_to, string p_str_CustPO, 
            string p_str_AlocId, string p_str_track_num, string p_str_batch_id, string p_str_shipdtFm, string p_str_shipdtTo, string p_str_status, string p_str_cust_name, string p_str_screen_title,
            string p_str_Style, string p_str_color, string p_str_size)
        {
            try
            {
                ...
                objOutboundInq.track_num = p_str_track_num;
        ...
        public ActionResult GetEcomOBOrdDetail(string p_str_cmp_id, string p_str_so_num_frm, string p_str_so_num_To, string p_str_so_dt_frm, string p_str_so_dt_to, string p_str_CustPO, string p_str_AlocId, string p_str_Store, string p_str_batch_id, string p_str_shipdtFm, string p_str_shipdtTo, string p_str_status, string p_str_cust_name, string p_str_screen_title,
            string p_str_Style, string p_str_color, string p_str_size)
        {
            try
            {
       ...
       string p_str_batch_id, string p_str_status, string p_str_shipdtFm, string p_str_shipdtTo, string type, string p_str_Style, string p_str_color, string p_str_size)
        ...
        public JsonResult SaveTempBOLBatchEntry(string p_str_cmp_id, string p_str_load_doc_id, string p_str_load_number, string p_str_load_approve_dt, string p_str_load_pick_dt, string p_str_so_list, List<OBSRLoadEntryHdr> objOBSRLoadEntryHdr)
        {
            string l_str_error_code = string.Empty;
            string[] strSoList;
            string l_str_load_number = string.Empty;
            ...
            string user_id = string.Empty;
            user_id = Session["UserID"].ToString();
            if (ServiceObject.SaveTempBol(p_str_cmp_id, l_str_load_number, p_str_so_list, objOBSRLoadEntryHdr, user_id, dtSoList) == true)
            {
        ...
        public ActionResult BOLBatchRpt(string p_str_cmp_id, string p_str_load_doc_id, string p_str_is_same_ship_to, string p_str_print_summary)
        {
            string strReportName = string.Empty;
            string jsonErrorCode = string.Empty;
            string msg = string.Empty;
            try
            {
                ...
                else
                {
                    ...
                    if (rptSource.Count > 0)
                    {
                        ...
                        string l_str_save_file_name = p_str_load_doc_id + "-" + l_str_dt + ".pdf";
                        MergePDF(l_str_file_1, l_str_file_2, l_str_bol_file_name);
        ...
        public ActionResult GetEcomAlocPostByBatch(string pstrCmpId, string pstrBatchNum)
        {
            ...
            Pick objPick = new Pick();
            PickService ServiceObjectPick = new PickService();
            objPick.cmp_id = pstrCmpId;
            objOBAlocPostInquiry.cmp_id = pstrCmpId;
            objOBAlocPostInquiry.batch_num = pstrBatchNum;
            objOBAlocPostInquiry = ServiceObject.GetEcomOBAlocOpenList(pstrCmpId, pstrBatchNum);
            Company objCompany = new Company();
            objCompany.user_id = Session["UserID"].ToString().Trim();
            objCompany = ServiceObjectCompany.GetPickCompanyDetails(objCompany);
            ...
            return PartialView("_EcomAlocPostByBatch", objOBAlocPostInquiryModel);
        }

        public ActionResult GetEcomBatchPost(string p_str_cmp_id, string p_str_batch_num, string p_str_load_number,
        ...
        public JsonResult LoadAvailQty(string p_str_cmp_id, string p_str_Itmcode, string p_str_style, string p_str_color, string p_str_size, string p_str_vendpo)
        {
            ...
            if (objOutboundInq.LstItmxCustdtl.Count > 0)
            {
                ...
                GetAvailQty(ref AvailQty, p_str_Itmcode, p_str_cmp_id, p_str_vendpo);//CR_MVC_3PL_20180411-001 Added By NIthya  
        ...
        public ActionResult OBCtnLblPrnt(string p_str_cmp_id, string p_str_screen_title, string p_str_so_num)
        {
            ...
            try
            {
                ...
                {
                    //objOBCtnLblPrnt.LstCtnLabelPrint[0].ship_from = objOBCtnLblPrnt.LstCtnLabelPrint[0].cmp_id + "    C/O CDC WAREHOUSE";
                    //objOBCtnLblPrnt.LstCtnLabelPrint[0].ship_from_addr1 = "   4271 EDISON AVE, CHINO, CA 91710";
                    //objOBCtnLblPrnt.LstCtnLabelPrint[0].ship_from_addr2 = "   CHINO, CA 91710";
