...
namespace GsEPWv8_4_MVC.Controllers
{
    public class eComSR940Controller : Controller
    {
        ...
        int resultCount = 0;
        public ActionResult eComSR940(string FullFillType, string cmp_id)
        {
            ...
            if (FullFillType != null)
            {
                ...
                objCompany = ServiceObjectCompany.GetPickCompanyDetails(objCompany);
                objeComSR940.ListCompanyPickDtl = objCompany.ListCompanyPickDtl;
                objeComSR940.cmp_id = cmp_id.Trim();
        ...
        protected void Save940ShipRequest()
        {
            eComSR940 objeComSR940 = new eComSR940();
            eComSR940Service ServiceObjecteComSR940 = new eComSR940Service();
        ...
        public ActionResult ShowReport(string p_str_cmpid, string type)
        {
            ...
            try
            {
                if (isValid)
                {
                    ...
                    if (type == "PDF")
                    {
                        //objeComSR940.ListeCom940SRUploadDtlRpt = tbl_so_dtl_rpt;
                        ...
                        objeComSR940.Image_Path = System.Web.HttpContext.Current.Server.MapPath("~/") + System.Configuration.ConfigurationManager.AppSettings["ReportLogo"].ToString().Trim(); //CR_3PL_MVC_BL_2018_0226_001 
        ...
        {
            return File("~\\uploads\\OB_SR940FILEUPLOAD.csv", "text/csv", string.Format("ViewTemplate-{0}.csv", DateTime.Now.ToString("yyyyMMdd-HHmmss")));
        }
        public FileResult downloadFileSample()
        {
            return File("~\\uploads\\OB_SR940FILEUPLOAD_SAMPLE.csv", "text/csv", string.Format("Sample-{0}.csv", DateTime.Now.ToString("yyyyMMdd-HHmmss")));
        }
        ...
        public ActionResult EComSR940InqDetail(string p_str_cmp_id, string p_str_so_dt_frm, string p_str_so_dt_to, string p_str_batch_id)
        {
            try
            {
        ...
        public ActionResult Show940SRReport(string var_name, string SelectedID, string p_str_cmpid, string p_str_so_dt_frm, string p_str_so_dt_to)
        {
