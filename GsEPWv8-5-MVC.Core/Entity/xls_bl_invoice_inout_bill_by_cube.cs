...
{
    public class xls_bl_invoice_inout_bill_by_cube : IDisposable
    {
        ...
        public xls_bl_invoice_inout_bill_by_cube(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_bill_doc_id, string p_str_bill_dt, string p_str_bill_by, decimal p_dbl_tot_amount, string l_str_cust_name)
        {
            ...
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "INBOUND BILL INVOICE DOCUMENT REPORT - BY " + p_str_bill_by;
            ...
            this.Names["__HDATA_bill_doc_dt"].Value = "INVOICE DATE : " + p_str_bill_dt;
            ExcelNamedRange ve2 = this.Names["__HDATA_bill_doc_dt"];
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_bl_shipctns"].Value = dr["bl_shipctns"];
                this.Names["__DATA_blcube"].Value = dr["blcube"];
                ...
                this.Names["__DATA_blso_itm_price"].Value = dr["blso_itm_price"];
