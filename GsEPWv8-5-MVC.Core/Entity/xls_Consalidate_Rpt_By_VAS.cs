...
{
    public class xls_Consalidate_Rpt_By_VAS : IDisposable
    {
        ...
        public xls_Consalidate_Rpt_By_VAS(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_bill_type)
        {
            ...
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "  BILL - CONSOLIDATED REPORT - VAS ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_bill_doc_dt"].Value = dr["bill_doc_dt"];
