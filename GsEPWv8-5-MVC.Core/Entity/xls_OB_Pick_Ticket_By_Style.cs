...
{
    public class xls_OB_Pick_Ticket_By_Style : IDisposable
    {
        ...
        public xls_OB_Pick_Ticket_By_Style(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_batch_id)
        {

            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "OB - PICK TICKET BY STYLE - REPORT";
            ExcelNamedRange ve = this.Names["__DataRptHeader"];

            this.Names["__HDATA_batch_id"].Value = "BATCH ID : " + p_str_batch_id;
            ExcelNamedRange ve1 = this.Names["__HDATA_batch_id"];
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                l_dec_ln_qty = Convert.ToDecimal(dr["ctn_cnt"]) * Convert.ToDecimal(dr["ctn_qty"]);
                this.Names["__DATA_ln_qty"].Value = l_dec_ln_qty.ToString();
                this.Names["__DATA_pick_cube"].Value = dr["pick_cube"];
