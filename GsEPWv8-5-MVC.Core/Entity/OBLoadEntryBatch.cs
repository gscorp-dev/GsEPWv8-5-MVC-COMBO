...
{
  public  class OBLoadEntryBatch
    {

    }

    public class OBLoadUploadDtl
    {
    ...
    public class OBLoadUploadFileInfo
    {
        #region Constructors  
        public OBLoadUploadFileInfo()
        {
    ...
    public class OBLoadUploadInvalidData
    {
        private string _batch_num;
