...
{
    public class xls_inv_as_of_date_by_style_smry : IDisposable
    {
        ...
        public xls_inv_as_of_date_by_style_smry(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_as_of_date)
        {

            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "Inventory As of Date Report by Style - " + p_str_as_of_date;
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_SlNo"].Value = i + 1;
                ...
                this.Names["__DATA_Stk_Length"].Value = dr["length"];
                this.Names["__DATA_Stk_Width"].Value = dr["width"];
                this.Names["__DATA_Stk_Depth"].Value = dr["depth"];
                this.Names["__DATA_Stk_Cube"].Value = dr["cube"];
                this.Names["__DATA_Stk_Weight"].Value = dr["wgt"];
                this.Names["__DATA_Avail_ctns"].Value = dr["avail_ctn"];
