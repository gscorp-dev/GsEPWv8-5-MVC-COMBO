...
{
    public class xls_OB_Pick_Ticket_By_Location : IDisposable
    {
        ...
        public xls_OB_Pick_Ticket_By_Location(string templateFile)
        {
        ...
        public void PopulateHeader(string l_str_cmp_id, string l_str_batch_id)
        {

            this.Names["__DataRptHeader"].Value = l_str_cmp_id + " - " + "OB - PICK TICKET BY LOCATION - REPORT";
            ExcelNamedRange ve = this.Names["__DataRptHeader"];

            this.Names["__HDATA_batch_id"].Value = "BATCH ID : " + l_str_batch_id;
