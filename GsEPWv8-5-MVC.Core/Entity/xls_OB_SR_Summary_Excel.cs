...
{
    public class xls_OB_SR_Summary_Excel : IDisposable
    {
        ...
        public xls_OB_SR_Summary_Excel(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id)
        {
            ...
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "OB - SR SUMMARY - REPORT ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_Sonum"].Value = dr["Sonum"];
                this.Names["__DATA_STATUS"].Value = dr["STATUS"];
                this.Names["__DATA_STEP"].Value = dr["STEP"];
                this.Names["__DATA_ShipreqDt"].Value = dr["ShipreqDt"];
                this.Names["__DATA_CUSTID"].Value = dr["CUSTID"];
                this.Names["__DATA_CustOrderNo"].Value = dr["CustOrderNo"];
                this.Names["__DATA_STOREID"].Value = dr["STOREID"];
                this.Names["__DATA_AlocdocId"].Value = dr["AlocdocId"];
