...
{
    public class xls_bl_invoice_strg_bill : IDisposable
    {
        ...
        public xls_bl_invoice_strg_bill(string templateFile, string p_str_bill_by)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_bill_doc_id, string p_str_bill_dt, string p_str_bill_by, string l_str_cust_name)
        {

            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "STORAGE BILL INVOICE DOCUMENT REPORT - BY " + p_str_bill_by;
            ...
            ExcelNamedRange ve3 = this.Names["__HDATA_cust_name"];
