...
{
    public class xls_inv_as_of_date_by_style : IDisposable
    {
        ...
        public xls_inv_as_of_date_by_style(string templateFile)
        {
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_Avail_ctns"].Value = dr["avail_cnt"];
                this.Names["__DATA_PPk"].Value = dr["pkg_qty"];
                this.Names["__DATA_avail_qty"].Value = dr["avail_qty"];

                this.Names["__DATA_FactoryId"].Value = dr["factory_id"];
                this.Names["__DATA_PoNum"].Value = dr["po_num"];
