...
{
    public class xls_IB_Recv_By_Date_Excel : IDisposable
    {
        ...
        public xls_IB_Recv_By_Date_Excel(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_RcvdDtFm, string p_str_RcvdDtTo)
        {
            ...
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "INBOUND RECEIVING REPORT BY DATE ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__Data_ib_load_dt"].Value = dr["ib_load_dt"];
