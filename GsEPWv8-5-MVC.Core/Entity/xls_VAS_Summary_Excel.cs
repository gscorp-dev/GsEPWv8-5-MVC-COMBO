...
{
    public class xls_VAS_Summary_Excel : IDisposable
    {
        ...
        public xls_VAS_Summary_Excel(string templateFile)
        {
        ...
        {
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "VAS SUMMARY - REPORT ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_VasDate"].Value = dr["VasDate"];
                this.Names["__DATA_status"].Value = dr["status"];
                this.Names["__DATA_TotAmount"].Value = dr["TotAmount"];
