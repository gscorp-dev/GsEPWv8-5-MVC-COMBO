...
{
    public class xls_Item_Details_Excel : IDisposable
    {
        ...
        public xls_Item_Details_Excel(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id)
        {
            ...
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "ITEM DETAILS - REPORT ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_ItemName"].Value = dr["ItemName"];
                this.Names["__DATA_sku_id"].Value = dr["sku_id"];
