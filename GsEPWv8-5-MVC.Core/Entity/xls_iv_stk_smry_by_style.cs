...
{
    public class xls_iv_stk_smry_by_style : IDisposable
    {
        ...
        public xls_iv_stk_smry_by_style(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string pstrOpenQty = "Y")
        {
            if (pstrOpenQty == "Y")
            {
                this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "    STOCK SUMMARY BY STYLE WITH OPEN TO SELL  ";

            }
            else
            {
                this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "  STOCK SUMMARY BY STYLE  ";
            }
        ...
        public void PopulateData(DataTable data, bool loadImage = false,string pstrOpenQty="Y")
        {
            if (data == null)
            {
                return;
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_Description"].Value = dr["Description"];

                this.Names["__DATA_WIP"].Value = dr["WIP_QTY"];
                this.Names["__DATA_STOCK"].Value = dr["STK_QTY"];
                this.Names["__DATA_ALLOCATED"].Value = dr["ALLOC_QTY"];
                this.Names["__DATA_AVAILABLE"].Value = dr["AVAIL_QTY"];
                if (pstrOpenQty=="Y")
                { 
                this.Names["__DATA_OPEN_ORDER_QTY"].Value = dr["OPEN_ORDER_QTY"];
                }
                //this.Names["__DATA_OPEN_TO_SELL_QTY"].Value = dr["OPEN_TO_SELL_QTY"];
