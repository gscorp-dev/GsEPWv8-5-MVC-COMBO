...
{
   public class xls_ob_sr_aloc_status : IDisposable
    {
        ...
        public xls_ob_sr_aloc_status(string templateFile)
        {
        ...
        {
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "SHIP REQUEST ALLOCATION STATUS REPORT";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_line_num"].Value = i + 1;
                this.Names["__DATA_sr_num"].Value = dr["sr_num"];
                this.Names["__DATA_proc_status"].Value = dr["proc_status"];
                this.Names["__DATA_error_desc"].Value = dr["error_desc"];
