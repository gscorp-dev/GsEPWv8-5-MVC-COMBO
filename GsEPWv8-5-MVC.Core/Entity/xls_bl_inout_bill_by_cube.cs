...
{
    public class xls_bl_inout_bill_by_cube : IDisposable
    {
        ...
        public xls_bl_inout_bill_by_cube(string templateFile)
        {
          ...
          
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                l_dec_amt = l_dec_total_cube * Convert.ToDecimal(dr["blso_itm_price"]);
