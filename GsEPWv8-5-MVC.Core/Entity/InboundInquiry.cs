...
namespace GsEPWv8_5_MVC.Core.Entity
{
    ...
    public class InboundGetInquiryDtl : BasicEntity
    {
 ...
 public string DocumentdateFrom { get; set; }
        ...
        public string v_rcvd_dt { get; set; }
    ...
    public class InboundACKExcel
    {
        public int LineNo { get; set; }
        public int ExpectedQty { get; set; }
        public int ExpectedCtn { get; set; }
        public int PPK { get; set; }
        ...
        public IList<InboundACKExcel> ListInboundAckExcelDetails { get; set; }

    }
    public class InboundWorkSheetExcel
    {
        public int LineNo { get; set; }
        public string ReceivedQty { get; set; }
        public string ReceivedCtns { get; set; }
        public int ExpectedQty { get; set; }
        public int ExpectedCtns { get; set; }
        public int PPK { get; set; }
        public string PONo { get; set; }
        ...
        public IList<InboundWorkSheetExcel> ListInboundWorkSheetExcelDetails { get; set; }

    }
    public class InboundTallySheetExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
        ...
        public IList<InboundTallySheetExcel> ListInboundTallySheetExcelDetails { get; set; }

    }
    public class InboundConfirmationExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
        ...
        public int PPk { get; set; }
        public int Pcs { get; set; }
        //CR-180417-001 Commented By Nithya
        //public string Itm_Code { get; set; }
        ////Added By Ravi 17-02-2018
        //public string CONTAINERID { get; set; }
        //public string CNTR_PALLET { get; set; }
        ...
        public IList<InboundConfirmationExcel> ListInboundConfrmExcelDetails { get; set; }

    }
    public class InboundGridSummaryExcel
    {
        public string IBDocId { get; set; }
        ...
        public string Note { get; set; }
        public string IOBillStatus { get; set; }


    }
    public class InboundInquiry : InboundGetInquiryDtl
    {
    ...
    public class IBDocExcp
    {
        ...
        public IList<IBDocExcp> ListIBDocExcp { get; set; }
    }


    public class IBRrecvDtlEditTemp
    {
        public string cmp_id { get; set; }
        public string ib_doc_id { get; set; }
        public int dtl_line { get; set; }
