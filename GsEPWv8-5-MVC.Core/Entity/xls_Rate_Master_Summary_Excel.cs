...
{
    public class xls_Rate_Master_Summary_Excel : IDisposable
    {
        ...
        public xls_Rate_Master_Summary_Excel(string templateFile)
        {
        ...
        {
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "RATE MASTER SUMMARY - REPORT ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_RateDesc"].Value = dr["RateDesc"];
                this.Names["__DATA_ListPrice"].Value = dr["ListPrice"];
                this.Names["__DATA_PriceUom"].Value = dr["PriceUom"];
                this.Names["__DATA_LastChangedDate"].Value = dr["LastChangedDate"];
