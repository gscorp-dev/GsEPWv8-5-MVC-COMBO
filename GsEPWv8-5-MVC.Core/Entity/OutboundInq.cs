...
namespace GsEPWv8_5_MVC.Core.Entity
{
    ...
    public class OB_SR_PickByStyleExcel
    {
        public string aloc_doc_id { get; set; }
        public string so_itm_num { get; set; }
        //public DateTime cmp_name { get; set; }
        //public string state_id { get; set; }
        //public string post_code { get; set; }
        //public string city { get; set; }
        //public string addr_line1 { get; set; }
    ...
    public class OB_SR_PickByLocExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        //public DateTime cmp_name { get; set; }
    ...
    public class OB_Grid_SummaryExcel
    {
        //public string cmp_id { get; set; }
    ...
    public class OB_StockverifyExcel
    {
        ...
        public int BackOrder_Qty { get; set; }
    ...
    public class OBStockverifyBOExcel
    {
        ...
        public int DueQty { get; set; }
        public int AvailQty { get; set; }
        public int CurrentAlocQty { get; set; }
    ...
    public class OutboundInq : BasicEntity
    {
        ...
        public string billprintdt { get; set; }
    ...
    public class SOTracking
    {
        public string cmp_id { get; set; }
        public string so_num { get; set; }
        public bool track_num_type { get; set; }
        public string track_num { get; set; }
    ...
    public class OBGetSRBOLConfRpt
    {
        public string cmp_id { get; set; }
        public string load_doc_id { get; set; }
        public string cmp_name { get; set; }
    ...
    public class lblCtnStyle
    {
        public string itm_num { get; set; }
        public int ordr_ctns { get; set; }
        public int itm_qty { get; set; }
    }
    public class OBCtnLblPrnt
    {
        #region Constructors  
        public OBCtnLblPrnt() { }
    ...
    public class OBGetSRSummary
    {
        ...
        private string _ordr_num;
        private int _tot_ctns;
        private int _tot_weight;
        private int _tot_cube;
        ...
        public string ordr_num { get { return _ordr_num; } set { _ordr_num = value; } }
        public int tot_ctns { get { return _tot_ctns; } set { _tot_ctns = value; } }
        public int tot_weight { get { return _tot_weight; } set { _tot_weight = value; } }
        public int tot_cube { get { return _tot_cube; } set { _tot_cube = value; } }
        public string add_info { get { return _add_info; } set { _add_info = value; } }


    }

    public class OBBOLDtl
    {
        private string _cmp_id;
        private string _batch_num;
        private string _so_num;
    ...
    public class OBDocExcp
    {
        ...
        public string SRDate { get; set; }
        public string AlocDocId { get; set; }
        public string AlocStatus { get; set; }
        public string AlocDate { get; set; }
        public string AlocPostDate { get; set; }
        public string CustId { get; set; }
        public string CustName { get; set; }
        public string OrderPickNumber { get; set; }
        public string CustOrderNumber { get; set; }
        public IList<OBDocExcp> ListOBDocExcp { get; set; }
    }
    public class OBSRShipTo
    {
        public string cmp_id { get; set; }
        public string batch_num { get; set; }
        public string shipto_id { get; set; }
    ...
    public class OBAlocPostByBatchDtl
    {
        private string _req_num;
        private string _cmp_id;
        private string _aloc_doc_id;
        ...
        private string _maker;
        private string _maker_dt;
        public string req_num { get { return _req_num; } set { _req_num = value; } }
        public string cmp_id { get { return _cmp_id; } set { _cmp_id = value; } }
        public string aloc_doc_id { get { return _aloc_doc_id; } set { _aloc_doc_id = value; } }
        public string aloc_post_dt { get { return _aloc_post_dt; } set { _aloc_post_dt = value; } }
        public string post_status { get { return _post_status; } set { _post_status = value; } }
        public string maker { get { return _maker; } set { _maker = value; } }
        public string maker_dt { get { return _maker_dt; } set { _maker_dt = value; } }
    }
    public class OBAlocPostInquiry
    {
        private string _cmp_id;
        private string _batch_num;
        private string _load_number;
    ...
    public class UPSPackageType
    {
        private string packageWeightField;
        private string packageWeightUOMField;
        private string packTypeCodeField;

        public string PackageWeight
        {
            get
            {
                return packageWeightField;
            }
        ...
        public string PackageWeightUOM
        {
            get
            {
                return packageWeightUOMField;
            }

            set
            {
                packageWeightUOMField = value;
            }
        }
        ...
        public string PackTypeCode
        {
            get
            {
                return packTypeCodeField;
            }

            set
            {
                packTypeCodeField = value;
            }
        }
    }


    public class UPSAddressType
    {
        ...
        public string StateProvinceCode
        {
            get
            {
                return stateProvinceCodeField;
            }

            set
            {
                stateProvinceCodeField = value;
            }
        }
    ...
    public class UPSServiceType
    {
        public string service_code { get; set; }
        public string service_name { get; set; }
    }
        public class shipOdrerDtl
    {
        public string cmp_id { get; set; }
        public int line_num { get; set; }
        public string itm_code { get; set; }
    ...
    public class UPSproductType
    {
        ...
        private string unitOfMeasurementCodeField;
        private string unitOfMeasurementDescriptionField;
        private string productWeightField;
        private string productWeightUoMField;
        private string productWeightDescriptionField;
        ...
        public string OriginCountryCode
        {
            get
            {
                return originCountryCodeField;
            }

            set
            {
                originCountryCodeField = value;
            }
        }
        ...
        public string UnitOfMeasurementCode
        {
            get
            {
                return unitOfMeasurementCodeField;
            }

            set
            {
                unitOfMeasurementCodeField = value;
            }
        }
        ...
        public string UnitOfMeasurementDescription
        {
            get
            {
                return unitOfMeasurementDescriptionField;
            }

            set
            {
                unitOfMeasurementDescriptionField = value;
            }
        }
        ...
        public string ProductWeightUoM
        {
            get
            {
                return productWeightUoMField;
            }

            set
            {
                productWeightUoMField = value;
            }
        }

        public string ProductWeightDescription
        {
            get
            {
                return productWeightDescriptionField;
            }

            set
            {
                productWeightDescriptionField = value;
            }
        }
    }

    public class UPSInternationalFormType
    {
        ...
        private string discountMonetaryValueField;
        private string freightMonetaryValueField;
        private string insuranceMonetaryValueField;
        private string otherChargesMonetaryValueField;
        ...
        public string DiscountMonetaryValue
        {
            get
            {
                return discountMonetaryValueField;
            }

            set
            {
                discountMonetaryValueField = value;
            }
        }

        public string FreightMonetaryValue
        {
            get
            {
                return freightMonetaryValueField;
            }

            set
            {
                freightMonetaryValueField = value;
            }
        }

        public string InsuranceMonetaryValue
        {
            get
            {
                return insuranceMonetaryValueField;
            }

            set
            {
                insuranceMonetaryValueField = value;
            }
        }

        public string OtherChargesMonetaryValue
        {
            get
            {
                return otherChargesMonetaryValueField;
            }

            set
            {
                otherChargesMonetaryValueField = value;
            }
        }
    ...
    public class UPSGsSecurity
    {
        ...
        public string AccessLicenseNumber
        {
            get
            {
                return accessLicenseNumberField;
            }

            set
            {
                accessLicenseNumberField = value;
            }
        }
    ...
    public class UPSShipper
    {
        ...
        private string shiperNameField;
        private string shiperAttentionNameField;
        private UPSAddressType shiperAddressField;
        private string shiperPhoneField;
        ...
        public string ShipperNumber
        {
            get
            {
                return shipperNumberField;
            }

            set
            {
                shipperNumberField = value;
            }
        }
        ...
        public string ShiperName
        {
            get
            {
                return shiperNameField;
            }

            set
            {
                shiperNameField = value;
            }
        }

        public string ShiperAttentionName
        {
            get
            {
                return shiperAttentionNameField;
            }

            set
            {
                shiperAttentionNameField = value;
            }
        }

        public UPSAddressType ShiperAddress
        {
            get
            {
                return shiperAddressField;
            }

            set
            {
                shiperAddressField = value;
            }
        }

        public string ShiperPhone
        {
            get
            {
                return shiperPhoneField;
            }

            set
            {
                shiperPhoneField = value;
            }
        }
    ...
    public class UPSShipTo
    {
        ...
        private string shipToAttentionNameField;
        private UPSAddressType shipToAddressField;
        private string shipToPhoneField;
        public string ShipToName
        {
            get
            {
                return shipToNameField;
            }

            set
            {
                shipToNameField = value;
            }
        }
        public string ShipToAttentionName
        {
            get
            {
                return shipToAttentionNameField;
            }

            set
            {
                shipToAttentionNameField = value;
            }
        }

        public UPSAddressType ShipToAddress
        {
            get
            {
        ...
        public string ShipToPhone
        {
            get
            {
                return shipToPhoneField;
            }

            set
            {
                shipToPhoneField = value;
            }
        }
    }
    public class UPSShipFrom
    {
        ...
        private string shipFromAttentionNameField;
        private UPSAddressType shipFromAddressField;
        private string shipFromPhoneField;
        public string ShipFromName
        {
            get
            {
                return shipFromNameField;
            }

            set
            {
                shipFromNameField = value;
            }
        }
        ...
        public string ShipFromAttentionName
        {
            get
            {
                return shipFromAttentionNameField;
            }

            set
            {
                shipFromAttentionNameField = value;
            }
        }

        public UPSAddressType ShipFromAddress
        {
            get
            {
        ...
        public string ShipFromPhone
        {
            get
            {
                return shipFromPhoneField;
            }

            set
            {
                shipFromPhoneField = value;
            }
        }
    }

    public class UPSSoldTo
    {
        private string soldToNameField;
        private string soldToAttentionNameField;
        private UPSAddressType soldToAddressField;
        private string soldToPhoneField;
        public string SoldToName
        {
            get
            {
                return soldToNameField;
            }

            set
            {
                soldToNameField = value;
            }
        }

        public string SoldToAttentionName
        {
            get
            {
                return soldToAttentionNameField;
            }

            set
            {
                soldToAttentionNameField = value;
            }
        }

        public UPSAddressType SoldToAddress
        {
            get
            {
                return soldToAddressField;
            }

            set
            {
                soldToAddressField = value;
            }
        }
        ...
        public string SoldToPhone
        {
            get
            {
                return soldToPhoneField;
            }

            set
            {
                soldToPhoneField = value;
            }
        }
    }
}