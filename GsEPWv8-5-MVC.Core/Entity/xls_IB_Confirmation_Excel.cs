...
{
    public class xls_IB_Confirmation_Excel : IDisposable
    {
        ...
        public xls_IB_Confirmation_Excel(string templateFile)
        {
        ...
        /// </summary>
        /// 
        public void PopulateHeader( string l_str_cmp_id, string l_str_doc_id, string l_str_ib_doc_dt, string l_str_cntr_id, string l_str_req_num, string l_str_palet_dt, string l_str_whs_id, string l_str_rate_id)
        {
            if(l_str_rate_id == "CNTR")
            {
                this.Names["__DataRptHeader"].Value = l_str_cmp_id + " - " + "INBOUND CONFIRMATION BY CONTAINER - REPORT ";
                ExcelNamedRange ve = this.Names["__DataRptHeader"];
            }
            else
            {
                this.Names["__DataRptHeader"].Value = l_str_cmp_id + " - " + "INBOUND CONFIRMATION - REPORT ";
                ExcelNamedRange ve = this.Names["__DataRptHeader"];
            }
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_FactoryId"].Value = dr["factory_id"];
                this.Names["__DATA_CustName"].Value = dr["cust_name"];
                this.Names["__DATA_CustPoNum"].Value = dr["cust_po_num"];
