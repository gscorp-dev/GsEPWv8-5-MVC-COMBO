...
{
    public class OB_SHIP_BOL_Excel
    {
    ...
    public class OB_SHIP_PACKING_SLIPExcel
    {
        public string ShipDocID { get; set; }
        public DateTime ShipDocDate { get; set; }
        ...
        //public int pick_qty { get; set; }
        //public int pick_ctns { get; set; }
        //public string shipto_id { get; set; }
        //public string SoldToId { get; set; }
        //public string fax { get; set; }
        //public string tel { get; set; }
    }
    public class OB_SHIP_Grid_SMRYExcel
    {
        //public string cmp_id { get; set; }
        public string ship_doc_id { get; set; }
    ...
    public class OutboundShipInq : BasicEntity
    {
        public string cmp_id { get; set; }
        public string ship_doc_id { get; set; }
        ...
        public string ship_to_mail_name { get; set; }
