...
{
    public class xls_bl_strg_bill : IDisposable
    {
        ...
        public xls_bl_strg_bill(string templateFile,string p_str_bill_by)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_bill_doc_id, string p_str_bill_dt, string p_str_bill_by, decimal p_dbl_tot_amount)
        {
            ...
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "STORAGE BILL DOCUMENT REPORT - BY " + p_str_bill_by;
