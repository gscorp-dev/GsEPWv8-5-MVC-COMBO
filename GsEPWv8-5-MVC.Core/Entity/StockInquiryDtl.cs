...
{
    public class StockAuditTrail_WithoutISMExcel
    {
    ...
    public class StockAuditTrail_Smry_OnlyISMExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
    ...
    public class AuditItemDtl
    {
      ...
      //  public string ItemCode { get; set; }
        ...
        public string OBDocId { get; set; }
        public int SRQty { get; set; }
        public string AlocDocId { get; set; }
        public string RefPickNumber { get; set; }
        public int AlocQty { get; set; }
        public string BalanceQty { get; set; }

    }

    public class StockAuditTrail_Smry_WithISMExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
    ...
    public class StockInquiryStyleDtlExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
    ...
    public class StockInquiryStyleSmryExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
    ...
    public class StockInquiryStyleSmmryExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
        ...
        public int OPEN_ORDER_QTY { get; set; }
      //  public int OPEN_TO_SELL_QTY { get; set; }

    }
    public class StockInquiryLocDtlExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
        ...
        //public int ALLOCATED { get; set; }
        //public int AVAILABLE { get; set; }
        //CR-180418-001 Commented by Nithya
        //public string Style { get; set; }
        //public string Color { get; set; }
        //public string Size { get; set; }       
        //public string Whs { get; set; }
    ...
    public class StockInquiryLocDtlBySummaryExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
    ...
    public class StockInquiryLocSmryExcel
    {
        public string Style { get; set; }
        public string Color { get; set; }
        public string Size { get; set; }
    ...
    public class StockInquiryDtl
    {
        ...
        public string AlocCtn { get; set; }
        public string Alocqty { get; set; }
