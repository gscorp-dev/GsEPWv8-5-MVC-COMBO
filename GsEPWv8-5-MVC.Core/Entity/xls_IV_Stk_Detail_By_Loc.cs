...
{
    public class xls_IV_Stk_Detail_By_Loc : IDisposable
    {
        ...
        public xls_IV_Stk_Detail_By_Loc(string templateFile)
        {
        ...
        public void PopulateHeader_IV_Stk_Detail_By_Loc_Excel(string p_str_cmp_id)
        {

            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "STOCK DETAIL by LOC";
        ...
        public void PopulateData_IV_Stk_Detail_By_Loc_Excel(IList<StockInquiryDtl> data, bool loadImage = false)
        {
            if (data == null)
            {
                return;
