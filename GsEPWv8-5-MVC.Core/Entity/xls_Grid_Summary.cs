...
{
    public class xls_Grid_Summary : IDisposable
    {
        ...
        public xls_Grid_Summary(string templateFile)
        {
        ...
        public void PopulateHeader(string p_str_cmp_id, string p_str_bill_type)
        {
            ...
            this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "  BILL - GRID SUMMARY REPORT ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            {              
                ...
                this.Names["__DATA_billdocdt"].Value = dr["billdocdt"];
                this.Names["__DATA_RptStatus"].Value = dr["RptStatus"];
                this.Names["__DATA_Bill_Type"].Value = dr["Bill_Type"];
                this.Names["__DATA_prod_cost"].Value = dr["prod_cost"];
                this.Names["__DATA_frgt_cost"].Value = dr["frgt_cost"];
                this.Names["__DATA_bill_amt"].Value = dr["bill_amt"];
