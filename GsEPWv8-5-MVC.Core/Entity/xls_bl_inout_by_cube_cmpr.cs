...
{
    public class xls_bl_inout_by_cube_cmpr : IDisposable
    {
        ...
        public xls_bl_inout_by_cube_cmpr(string templateFile)
        {
        ...
        public void PopulateHeader( string p_str_cmp_id, string p_str_bill_type)
        {
                ...
                this.Names["__DataRptHeader"].Value = p_str_cmp_id + " - " + "  BILL BY CUBE - COMPARISION REPORT ";
        ...
        public void PopulateData(DataTable data, bool loadImage = false)
        {
            ...
            for (int i = 0; i < rowSize; i++)
            {
                ...
                this.Names["__DATA_BillDocId"].Value = dr["BillDocId"];
                this.Names["__DATA_LineNum"].Value = dr["LineNum"];
                this.Names["__DATA_IbDocId"].Value = dr["IbDocId"];
                this.Names["__DATA_IBDocDate"].Value = dr["IBDocDate"];

                this.Names["__DATA_Container"].Value = dr["Container"];
                this.Names["__DATA_RcvdDate"].Value = dr["RcvdDate"];
                ...
                this.Names["__DATA_TotalQty"].Value = dr["TotalQty"];
                this.Names["__DATA_TotalCtns"].Value = dr["TotalCtns"];
                
                this.Names["__DATA_RatePrice"].Value = dr["RatePrice"];

                this.Names["__Data_BilledCube"].Value = dr["BilledCube"];
                this.Names["__Data_BilledAmount"].Value = dr["BilledAmount"];

                this.Names["__Data_ActualCube"].Value = dr["ActualCube"];
                this.Names["__Data_ActualAmount"].Value = dr["ActualAmount"];

                this.Names["__Data_RoundedCube"].Value = dr["RoundedCube"];
                this.Names["__Data_AmountRounded"].Value = dr["AmountRounded"];
